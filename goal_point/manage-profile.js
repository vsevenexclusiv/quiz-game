...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const manageProfileBtn = document.getElementById("manageProfile"); // Added here to fix the reference error
    ...
    function showStore() {
        ...
        // Link to avatar/nft shop or expand later
    }

    function showVault() {
        alert("Vault: View your Coins and history!");
        // Could link to banker/coins display
    }
    ...
    claimChallengeBtn?.addEventListener("click", () => {
        if (!dailyChallenge.completed && dailyChallenge.progress >= 1) {
            ...
            // Note: Animation requires DOM elements from index.html, so we'll skip here
